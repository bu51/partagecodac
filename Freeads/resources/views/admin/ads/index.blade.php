            ...
            <div class="w-full lg:w-8/12">
                ...
                <div class="mt-6">
                    <div class="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
                        ...
                        <a href="{{ route('admin.ads.edit',$ad) }}" class="px-2 py-1 font-bold text-white-100 bg-yellow-600 rounded hover:bg-yellow-500">Edit</a>
                        <a href="#" class="px-2 py-1 font-bold text-gray-100 bg-red-600 rounded hover:bg-red-500"
                         onclick="event.preventDefault;document.getElementById('destroy-form').submit();">Delete
                            <form id="destroy-form" style="display:none;" method="post" action="{{ route('admin.ads.destroy',$ad) }}">
                                @csrf
                                @method('delete')
                            </form>
                        </a>
